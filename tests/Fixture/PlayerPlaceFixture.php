 ...
 * PlayerPlaceFixture
 */
class PlayerPlaceFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_place_tour' => ['type' => 'foreign', 'columns' => ['tourPlay'], 'references' => ['tournament_player', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
